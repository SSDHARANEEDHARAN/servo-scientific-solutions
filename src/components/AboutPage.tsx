      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="mb-20">
          <div className="mb-12">
            ...
            <h2 className="text-4xl font-bold text-foreground mb-3">Meet Our Visionary Leaders</h2>
            <div className="h-0.5 w-16 bg-primary"></div>
          </div>
            ...
            <Card>
              <CardContent className="p-8">
                <div className="flex flex-col items-center text-center">
                  ...
                  <div className="inline-flex items-center gap-2 bg-muted px-3 py-1 rounded mb-4">
                    <span className="text-sm font-medium text-muted-foreground">Founder & Chairman</span>
                  </div>
                  ...
                  <div className="inline-flex items-center gap-2 bg-primary/10 px-3 py-1.5 rounded">
                    <Award className="h-4 w-4 text-primary" />
                    <span className="text-xs font-medium text-primary">Padma Shri Recipient</span>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-8">
                <div className="flex flex-col items-center text-center">
                  ...
                  <div className="inline-flex items-center gap-2 bg-muted px-3 py-1 rounded mb-4">
                    <span className="text-sm font-medium text-muted-foreground">Managing Director</span>
                  </div>
                  ...
                  <div className="inline-flex items-center gap-2 bg-primary/10 px-3 py-1.5 rounded">
                    <Award className="h-4 w-4 text-primary" />
                    <span className="text-xs font-medium text-primary">Business Excellence Award</span>
                  </div>
                </div>
              </CardContent>
            </Card>
