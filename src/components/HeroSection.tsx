...
const HeroSection: React.FC<HeroSectionProps> = ({ onInquiryClick }) => {
  return (
    <section className="relative bg-gradient-hero dark:bg-gradient-to-br dark:from-slate-900 dark:to-slate-800 py-40 min-h-[120vh] flex items-center overflow-hidden">
      {/* Background Pattern */}
